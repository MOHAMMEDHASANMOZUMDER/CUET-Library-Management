    ...
    const outstandingFines = [
        {
            ...
            bookImage: 'https://via.placeholder.com/60x80?text=Networks',
        ...
        },
        {
            ...
            bookImage: 'https://via.placeholder.com/60x80?text=DB',
            ...
            totalFine: 15,
            fineType: 'renewal',
            description: 'Renewal fee for extending due date',
            canPay: true
        },
        {
            id: 3,
            ...
            bookImage: 'https://via.placeholder.com/60x80?text=SE',
...
function processPayment() {
    ...
    const processingMessage = `Processing payment of ৳${amount} via ${method.toUpperCase()}...`;
